...
public class MainWindow extends JFrame {
	...
	private void setHelpMessage() {
		...
		helpMessage[1] = "The current players Lander is" + " highlighted white.";
		helpMessage[2] = "All of the current players info" + " is on the right of the screen.";
		helpMessage[3] = "To change the angle, use the box" + " on the right labeled angle, by pressing up" + " or down to change the angle, or typing in a " + " new angle";
		helpMessage[4] = "To change the power, use the box" + " on the right labeled power, by pressing up" + " or down to change the power, or typing in a " + " new power";
		helpMessage[5] = "Use integers (regular numbers, no" + " decimals) for the angle and power!";
		helpMessage[6] = "After you have adjusted the angle" + " and power to what you would like, to end your" + " turn, press the fire button.";
		helpMessage[7] = "The rockets will" + " not fire until ever player has set their angle" + " and power, and after the last player has pressed"
				+ " the fire button, all the missiles will fire at" + " once.";
		helpMessage[8] = "To make the game easier, use the check" + "box on the right, and the players will be able to" + " see where the rocket will go";
	}
}
